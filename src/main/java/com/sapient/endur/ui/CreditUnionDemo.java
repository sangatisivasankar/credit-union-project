...
public class CreditUnionDemo {
	...
	private static void populateAccounts(Account[] accounts) {
		accounts[0]= 
				new ConsumerAccount(675876876L,AccountType.MONEY_MARKET,"Smith",LocalDate.of(2010, 9, 1),350000.0);
		accounts[1]= new CommercialAccount(565478987L,AccountType.MONEY_MARKET,"Clarke",LocalDate.of(2019, 10,10),1000000.0);;
		accounts[2]= 
				new ConsumerAccount(655786909L,AccountType.MONEY_MARKET,"Jones",LocalDate.of(2000, 10, 10),550000.0);
		accounts[3]= new CertificateOfDepositAccount(808765456L,AccountType.CERTIFICATE_OF_DEPOSIT,
							"Rohit Sharma",LocalDate.of(2012, 10, 5), 500000.0,LocalDate.of(2015, 10, 5));
		accounts[4]= new CertificateOfDepositAccount(805705000L,AccountType.CERTIFICATE_OF_DEPOSIT,
				"Virat Kohli",LocalDate.of(2020, 1, 1), 500000.0,LocalDate.of(2025, 1, 1));
	}
